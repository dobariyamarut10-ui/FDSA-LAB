...
int findBook(int arr[], int bookCode, int left, int right)
{
   ...
   {
      return findBook(arr, bookCode, left, mid - 1);
   }
}
...
{
   int n;
   cout << "How many book codes you want to enter" << endl;
   cin >> n;
   ...
   cout << "Your book found at position "
        << findBook(arr, bookCode, left, right) << endl;
